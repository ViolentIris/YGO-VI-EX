...
void Game::DrawMisc() {
	...
	//avatar image
	driver->draw2DImage(imageManager.tAvatar[0], Resize(445, 8, 508, 71), recti(0, 0, 160, 160), 0, 0, true);
	driver->draw2DImage(imageManager.tAvatar[1], Resize(808, 8, 871, 71), recti(0, 0, 160, 160), 0, 0, true);
