...
void Game::DrawMisc() {
	...
	driver->draw2DImage(imageManager.tAvatar[0], Resize(328, 60, 408, 140), recti(0, 0, 160, 160), 0, 0, true);
	driver->draw2DImage(imageManager.tAvatar[1], Resize(910.5, 60, 990.5, 140), recti(0, 0, 160, 160), 0, 0, true);
