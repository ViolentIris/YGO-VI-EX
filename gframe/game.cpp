...
bool Game::Initialize() {
	...
	btnSC = env->addButton(rect<s32>(320, 325, 420, 350), wLanWindow, BUTTON_SERVER_CHOOSE, dataManager.GetSysString(1434));
	...
	//server choose
	wSC = env->addWindow(rect<s32>(380, 210, 660, 420), false, dataManager.GetSysString(1441));
...
void Game::OnResize() {
	...
	wSC->setRelativePosition(ResizeWin(380, 210, 660, 420));
