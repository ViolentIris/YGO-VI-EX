...
bool Game::Initialize() {
	...
	btnSC = env->addButton(rect<s32>(340, 325, 440, 350), wLanWindow, BUTTON_SERVER_CHOOSE, dataManager.GetSysString(1434));
	...
	//server choose
	wSC = env->addWindow(rect<s32>(430, 160, 710, 370), false, dataManager.GetSysString(1441));
