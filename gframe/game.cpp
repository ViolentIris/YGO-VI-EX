...
bool Game::Initialize() {
	...
	btnLanRefresh = env->addButton(rect<s32>(170, 325, 270, 350), wLanWindow, BUTTON_LAN_REFRESH, dataManager.GetSysString(1217));
	env->addStaticText(dataManager.GetSysString(1221), rect<s32>(10, 360, 220, 380), false, false, wLanWindow);
	btnSC = env->addButton(rect<s32>(310, 325, 410, 350), wLanWindow, BUTTON_SERVER_CHOOSE, dataManager.GetSysString(1434));
	...
	//server choose
	wSC = env->addWindow(rect<s32>(380, 280, 660, 390), false, dataManager.GetSysString(1441));
