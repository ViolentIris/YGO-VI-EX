...
bool Game::Initialize() {
	...
	//other
	wOther = env->addWindow(rect<s32>(370, 200, 650, 518), false, dataManager.GetSysString(1422));
	...
	btnWBO = env->addButton(rect<s32>(10, 240, 270, 270), wOther, BUTTON_WBO, dataManager.GetSysString(1445));
