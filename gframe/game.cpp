...
bool Game::Initialize() {
	...
	//other
	wOther = env->addWindow(rect<s32>(370, 200, 650, 477), false, dataManager.GetSysString(1422));
	...
	btnOtherExit = env->addButton(rect<s32>(10, 240, 270, 270), wOther, BUTTON_OTHER_EXIT, dataManager.GetSysString(1210));
	...
	btnLanRefresh = env->addButton(rect<s32>(190, 325, 290, 350), wLanWindow, BUTTON_LAN_REFRESH, dataManager.GetSysString(1217));
	env->addStaticText(dataManager.GetSysString(1221), rect<s32>(10, 360, 220, 380), false, false, wLanWindow);
	btnSC = env->addButton(rect<s32>(330, 325, 430, 350), wLanWindow, BUTTON_SERVER_CHOOSE, dataManager.GetSysString(1434));
	...
	//server choose
	wSC = env->addWindow(rect<s32>(400, 180, 680, 390), false, dataManager.GetSysString(1441));
	...
	posY += 30;
	chkEnablePScale = env->addCheckBox(false, rect<s32>(posX, posY, posX + 260, posY + 25), tabHelper, -1, dataManager.GetSysString(1287));
